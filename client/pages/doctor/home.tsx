...
export default function home() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/patient")
      ...
      .then((responseData) => {
        console.log(responseData.data.patient);
        // Imprimir los datos recibidos
        if (responseData && responseData.data && responseData.data.patient) {
          setData(responseData.data.patient); // Almacenar los datos de los pacientes en el estado
        } else {
